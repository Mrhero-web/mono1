...
public class EItem2 implements Serializable {
    ...
    public EItem2 eItemResult(Long eItemResult) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof EItem2)) {
            return false;
        }
        return id != null && id.equals(((EItem2) o).id);
    }
