 ...
 * 历史签到记录
 */
@Schema(description = "历史签到记录")
@Entity
@Table(name = "past_student_records")
@Cache(usage = CacheConcurrencyStrategy.READ_WRITE)
public class PastStudentRecords implements Serializable {
    ...
    public PastStudentRecords id(Long id) {
        this.setId(id);
        return this;
    }
    ...
    public PastStudentRecords crId(Long crId) {
        this.setCrId(crId);
        return this;
    }
    ...
    public PastStudentRecords pId(Long pId) {
        this.setpId(pId);
        return this;
    }
    ...
    public PastStudentRecords signIn(SignInStatus signIn) {
    ...
    public PastStudentRecords signInTime(Instant signInTime) {
    ...
    public PastStudentRecords signInImage(String signInImage) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof PastStudentRecords)) {
            return false;
        }
        return id != null && id.equals(((PastStudentRecords) o).id);
    }
