...
import com.ledar.mono.repository.DepartmentRepository;
...
class DepartmentResourceIT {
    ...
    private static final String DEFAULT_D_MANAGER = "AAAAAAAAAA";
    private static final String UPDATED_D_MANAGER = "BBBBBBBBBB";
    ...
    public static Department createEntity(EntityManager em) {
        Department department = new Department().dName(DEFAULT_D_NAME).dManager(DEFAULT_D_MANAGER).dNum(DEFAULT_D_NUM);
        return department;
    }
    ...
    public static Department createUpdatedEntity(EntityManager em) {
        Department department = new Department().dName(UPDATED_D_NAME).dManager(UPDATED_D_MANAGER).dNum(UPDATED_D_NUM);
        return department;
    }
    ...
    void createDepartment() throws Exception {
        ...
        assertThat(testDepartment.getdName()).isEqualTo(DEFAULT_D_NAME);
        assertThat(testDepartment.getdManager()).isEqualTo(DEFAULT_D_MANAGER);
        assertThat(testDepartment.getdNum()).isEqualTo(DEFAULT_D_NUM);
    }
    ...
    void getAllDepartments() throws Exception {
        ...
        restDepartmentMockMvc
            ...
            .andExpect(jsonPath("$.[*].dManager").value(hasItem(DEFAULT_D_MANAGER)))
    ...
    void getDepartment() throws Exception {
        ...
        restDepartmentMockMvc
            ...
            .andExpect(jsonPath("$.dManager").value(DEFAULT_D_MANAGER))
    ...
    void putNewDepartment() throws Exception {
        ...
        updatedDepartment.dName(UPDATED_D_NAME).dManager(UPDATED_D_MANAGER).dNum(UPDATED_D_NUM);
        ...
        Department testDepartment = departmentList.get(departmentList.size() - 1);
        assertThat(testDepartment.getdName()).isEqualTo(UPDATED_D_NAME);
        assertThat(testDepartment.getdManager()).isEqualTo(UPDATED_D_MANAGER);
        assertThat(testDepartment.getdNum()).isEqualTo(UPDATED_D_NUM);
    }
    ...
    void partialUpdateDepartmentWithPatch() throws Exception {
        ...
        partialUpdatedDepartment.dManager(UPDATED_D_MANAGER);
    ...
    void fullUpdateDepartmentWithPatch() throws Exception {
        ...
        partialUpdatedDepartment.dName(UPDATED_D_NAME).dManager(UPDATED_D_MANAGER).dNum(UPDATED_D_NUM);
