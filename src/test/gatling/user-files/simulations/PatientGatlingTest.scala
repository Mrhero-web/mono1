    ...
    val scn = scenario("Test the Patient entity")
        ...
        .repeat(2) {
            ...
            .body(StringBody("""{
                ...
                , "dischargedDate":"2020-01-01T00:00:00.000Z"
                , "admissionDepartmentId":"0"
                , "daysInHospital":"0"
                , "hospitalPhysician":"SAMPLE_TEXT"
                , "therapist":"SAMPLE_TEXT"
                , "admissionMethod":"SAMPLE_TEXT"
                , "currentDepartmentId":"0"
                , "patientType":"ADULT"
                , "fromHospitalSystem":null
                , "login":"SAMPLE_TEXT"
