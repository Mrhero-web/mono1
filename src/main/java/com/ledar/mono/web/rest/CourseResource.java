...
/**
 * REST controller for managing {@link com.ledar.mono.domain.Course}.
 */
@RestController
@RequestMapping("/api")
@Transactional
    ...
    public ResponseEntity<Course> partialUpdateCourse(
        ...
        Optional<Course> result = courseRepository
            ...
            .map(existingCourse -> {
                ...
                if (course.getcIntroduce() != null) {
                    existingCourse.setcIntroduce(course.getcIntroduce());
                }
                if (course.getdId() != null) {
                    existingCourse.setdId(course.getdId());
                }
                if (course.getcType() != null) {
                    existingCourse.setcType(course.getcType());
                }
