...
/**
 * REST controller for managing {@link com.ledar.mono.domain.Menu}.
 */
@RestController
@RequestMapping("/api")
@Transactional
        ...
        Optional<Menu> result = menuRepository
            ...
            .map(existingMenu -> {
                ...
                if (menu.getParentIds() != null) {
                    existingMenu.setParentIds(menu.getParentIds());
                }
                if (menu.getTreeSort() != null) {
                    existingMenu.setTreeSort(menu.getTreeSort());
                }
                if (menu.getTreeSorts() != null) {
                    existingMenu.setTreeSorts(menu.getTreeSorts());
                }
                if (menu.getTreeLeaf() != null) {
                    existingMenu.setTreeLeaf(menu.getTreeLeaf());
                }
                if (menu.getTreeLevel() != null) {
                    existingMenu.setTreeLevel(menu.getTreeLevel());
                }
                if (menu.getTreeNames() != null) {
                    existingMenu.setTreeNames(menu.getTreeNames());
                }
                ...
                if (menu.getMenuHref() != null) {
                    existingMenu.setMenuHref(menu.getMenuHref());
                }
                if (menu.getMenuIcon() != null) {
                    existingMenu.setMenuIcon(menu.getMenuIcon());
                }
                if (menu.getMenuTitle() != null) {
                    existingMenu.setMenuTitle(menu.getMenuTitle());
                }
                if (menu.getPermission() != null) {
                    existingMenu.setPermission(menu.getPermission());
                }
                if (menu.getMenuSort() != null) {
                    existingMenu.setMenuSort(menu.getMenuSort());
                }
                if (menu.getIsShow() != null) {
                    existingMenu.setIsShow(menu.getIsShow());
                }
                if (menu.getSysCode() != null) {
                    existingMenu.setSysCode(menu.getSysCode());
                }
                if (menu.getStatus() != null) {
                    existingMenu.setStatus(menu.getStatus());
                }
                if (menu.getRemarks() != null) {
                    existingMenu.setRemarks(menu.getRemarks());
                }
