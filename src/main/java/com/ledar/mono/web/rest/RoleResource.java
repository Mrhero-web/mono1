...
/**
 * REST controller for managing {@link com.ledar.mono.domain.Role}.
 */
@RestController
@RequestMapping("/api")
@Transactional
    ...
    public ResponseEntity<Role> partialUpdateRole(
        ...
        Optional<Role> result = roleRepository
            ...
            .map(existingRole -> {
                ...
                if (role.getRoleNameInEn() != null) {
                    existingRole.setRoleNameInEn(role.getRoleNameInEn());
                }
                if (role.getRoleNameInCn() != null) {
                    existingRole.setRoleNameInCn(role.getRoleNameInCn());
                }
                if (role.getRoleStatus() != null) {
                    existingRole.setRoleStatus(role.getRoleStatus());
                }
                if (role.getWebOrApp() != null) {
                    existingRole.setWebOrApp(role.getWebOrApp());
                }
