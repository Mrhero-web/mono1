...
/**
 * REST controller for managing {@link com.ledar.mono.domain.Department}.
 */
@RestController
@RequestMapping("/api")
@Transactional
    ...
    public ResponseEntity<Department> partialUpdateDepartment(
        ...
        Optional<Department> result = departmentRepository
            ...
            .map(existingDepartment -> {
                ...
                if (department.getdManager() != null) {
                    existingDepartment.setdManager(department.getdManager());
                }
                if (department.getdNum() != null) {
                    existingDepartment.setdNum(department.getdNum());
                }
