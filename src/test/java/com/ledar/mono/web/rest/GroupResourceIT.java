...
import com.ledar.mono.repository.GroupRepository;
...
class GroupResourceIT {
    ...
    private static final Long DEFAULT_GROUP_LEADER_STAFF_ID = 1L;
    private static final Long UPDATED_GROUP_LEADER_STAFF_ID = 2L;
    ...
    public static Group createEntity(EntityManager em) {
        Group group = new Group().groupLeaderStaffId(DEFAULT_GROUP_LEADER_STAFF_ID).departmentId(DEFAULT_DEPARTMENT_ID);
        return group;
    }
    ...
    public static Group createUpdatedEntity(EntityManager em) {
        Group group = new Group().groupLeaderStaffId(UPDATED_GROUP_LEADER_STAFF_ID).departmentId(UPDATED_DEPARTMENT_ID);
        return group;
    }
    ...
    void createGroup() throws Exception {
        ...
        assertThat(testGroup.getGroupLeaderStaffId()).isEqualTo(DEFAULT_GROUP_LEADER_STAFF_ID);
        assertThat(testGroup.getDepartmentId()).isEqualTo(DEFAULT_DEPARTMENT_ID);
    }
    ...
    @Test
    @Transactional
    void checkGroupLeaderStaffIdIsRequired() throws Exception {
        int databaseSizeBeforeTest = groupRepository.findAll().size();
        // set the field null
        group.setGroupLeaderStaffId(null);
    ...
    void getAllGroups() throws Exception {
        ...
        restGroupMockMvc
            ...
            .andExpect(jsonPath("$.[*].groupLeaderStaffId").value(hasItem(DEFAULT_GROUP_LEADER_STAFF_ID.intValue())))
    ...
    void getGroup() throws Exception {
        ...
        restGroupMockMvc
            ...
            .andExpect(jsonPath("$.groupLeaderStaffId").value(DEFAULT_GROUP_LEADER_STAFF_ID.intValue()))
    ...
    void putNewGroup() throws Exception {
        ...
        updatedGroup.groupLeaderStaffId(UPDATED_GROUP_LEADER_STAFF_ID).departmentId(UPDATED_DEPARTMENT_ID);
        ...
        Group testGroup = groupList.get(groupList.size() - 1);
        assertThat(testGroup.getGroupLeaderStaffId()).isEqualTo(UPDATED_GROUP_LEADER_STAFF_ID);
        assertThat(testGroup.getDepartmentId()).isEqualTo(UPDATED_DEPARTMENT_ID);
    }
    ...
    void fullUpdateGroupWithPatch() throws Exception {
        ...
        partialUpdatedGroup.groupLeaderStaffId(UPDATED_GROUP_LEADER_STAFF_ID).departmentId(UPDATED_DEPARTMENT_ID);
