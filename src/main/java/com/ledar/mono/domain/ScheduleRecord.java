...
public class ScheduleRecord implements Serializable {
    ...
    public ScheduleRecord id(Long id) {
        this.setId(id);
        return this;
    }
    ...
    public ScheduleRecord cureProjectNum(Long cureProjectNum) {
    ...
    public ScheduleRecord cureId(Long cureId) {
    ...
    public ScheduleRecord name(String name) {
        this.setName(name);
        return this;
    }
    ...
    public ScheduleRecord scheduleTime(Instant scheduleTime) {
    ...
    public ScheduleRecord scheduleIsachive(Confirmation scheduleIsachive) {
    ...
    public ScheduleRecord scheduleCureTime(Instant scheduleCureTime) {
    ...
    public ScheduleRecord detailsNum(Long detailsNum) {
    ...
    public ScheduleRecord photoUrl(String photoUrl) {
    ...
    public boolean equals(Object o) {
        ...
        return id != null && id.equals(((ScheduleRecord) o).id);
    }
