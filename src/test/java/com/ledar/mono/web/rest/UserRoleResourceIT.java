...
class UserRoleResourceIT {
    ...
    public static UserRole createEntity(EntityManager em) {
        UserRole userRole = new UserRole().userId(DEFAULT_USER_ID).roleId(DEFAULT_ROLE_ID);
        return userRole;
    }
    ...
    public static UserRole createUpdatedEntity(EntityManager em) {
        UserRole userRole = new UserRole().userId(UPDATED_USER_ID).roleId(UPDATED_ROLE_ID);
        return userRole;
    }
    ...
    void putNewUserRole() throws Exception {
        ...
        updatedUserRole.userId(UPDATED_USER_ID).roleId(UPDATED_ROLE_ID);
    ...
    void fullUpdateUserRoleWithPatch() throws Exception {
        ...
        partialUpdatedUserRole.userId(UPDATED_USER_ID).roleId(UPDATED_ROLE_ID);
