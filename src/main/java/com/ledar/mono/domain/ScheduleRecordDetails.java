 ...
 * 预先排程记录详情表
 */
@Schema(description = "预先排程记录详情表")
@Entity
@Table(name = "schedule_record_details")
@Cache(usage = CacheConcurrencyStrategy.READ_WRITE)
public class ScheduleRecordDetails implements Serializable {
    ...
    public ScheduleRecordDetails id(Long id) {
        this.setId(id);
        return this;
    }
    ...
    public ScheduleRecordDetails dName(String dName) {
        this.setdName(dName);
        return this;
    }
    ...
    public ScheduleRecordDetails cureId(Long cureId) {
    ...
    public ScheduleRecordDetails medicalNumber(Long medicalNumber) {
    ...
    public ScheduleRecordDetails dNum(Long dNum) {
        this.setdNum(dNum);
        return this;
    }
    ...
    public ScheduleRecordDetails idNum(String idNum) {
        this.setIdNum(idNum);
        return this;
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ScheduleRecordDetails)) {
            return false;
        }
        return id != null && id.equals(((ScheduleRecordDetails) o).id);
    }
